...
def test_batchsplitter_with_vertex_tokenizer():
    ...
    messages = [
        ...
        {"channel": "A", "time": "2025-01-01 12:02", "text": "hi there, this is a long message for token testing."},
        {"channel": "B", "time": "2025-01-01 12:03", "text": "에어드랍 참여법을 알려주세요."},
        {"channel": "B", "time": "2025-01-01 12:04", "text": "멀티라인\n메시지\ntest!"},
        {"channel": "B", "time": "2025-01-01 12:05", "text": "# Markdown Title\n- Item1\n- Item2\nEnd."},
