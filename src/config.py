...
TELEGRAM_TARGET_CHATS = [chat.strip() for chat in _target_chats_str.split(',') if chat.strip()]
...
LIGHTWEIGHT_MODEL_CONTEXT_WINDOW_SIZE = int(os.getenv("LIGHTWEIGHT_MODEL_CONTEXT_WINDOW_SIZE", "1000000"))
BATCH_TARGET_WINDOW_PERCENTAGE = float(os.getenv("BATCH_TARGET_WINDOW_PERCENTAGE", "0.80"))

# Optional: Model for final, more complex analysis
FINAL_ANALYSIS_MODEL_NAME = os.getenv("FINAL_ANALYSIS_MODEL_NAME") # Defaults to None if not set

# --- File Paths and Directories ---
DATA_DIRECTORY_ROOT = os.getenv("DATA_DIRECTORY_ROOT", "data")
FIRST_PASS_PROMPT_FILE_PATH = os.getenv("FIRST_PASS_PROMPT_FILE_PATH", "prompts/1st_pass_filter_prompt.md")
